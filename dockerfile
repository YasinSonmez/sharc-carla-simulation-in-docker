...
ENV PYTHONPATH="/home/carla/PythonAPI/carla/dist/carla-0.9.12-py3.7-linux-x86_64.egg:/home/carla/PythonAPI/carla:/home/carla/PythonAPI"
...
ENV VIRTUAL_ENV=/home/carla/PythonAPI/venv
...
RUN pip install py_trees==0.8.3 networkx==2.2 six==1.14.0 psutil==5.7.0 shapely==1.7.0 xmlschema==1.1.3 ephem==3.7.6.0 tabulate==0.8.7 simple_watchdog_timer
RUN pip install matplotlib scipy
RUN pip install opencv-python
RUN pip install --no-input pandas
